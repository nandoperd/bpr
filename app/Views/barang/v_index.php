                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                        ...
                                        <!-- <tbody>
                                            <?php $no = 1; foreach ($d as $key => $value) { 
                                                ...
                                                elseif ($status == 2): 
                                                    ...
                                                    $status_text = 'Sudah Diproses';
                                                elseif ($status == 3): 
                                                    $status_badge_class = 'bg-warning';
                                                    $status_text = 'Barang Diajukan';
                                                elseif ($status == 4): 
                                                    $status_badge_class = 'bg-info';
                                                    $status_text = 'Disetujui Accounting';
                                                elseif ($status == 5): 
                                                    $status_badge_class = 'bg-success';
                                                    $status_text = 'Pengajuan Diterima';
                                                else: 
                                                    $status_badge_class = 'bg-secondary';
                                                    $status_text = 'Tidak Diketahui';
                                                endif; 
                                                
                                                $isDisabled = in_array($status, [3, 4, 5]);
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge <?= $status_badge_class ?> px-3 py-2" style="font-size: 12px;">
                                                        <?= $status_text ?>
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <?php if ($isDisabled): ?>
                                                        <a class="btn btn-warning btn-sm disabled" href="#" onclick="return false;" title="Tidak dapat diedit (barang sedang dalam proses pengajuan)">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <button class="btn btn-danger btn-sm disabled" onclick="return false;" title="Tidak dapat dihapus (barang sedang dalam proses pengajuan)">
                                                            <i class="fa fa-trash"></i>
                                                        </button>
                                                        <a class="btn btn-primary btn-sm disabled" href="#" onclick="return false;" title="Tidak dapat diproses (barang sedang dalam proses pengajuan)">
                                    ...
                                    <?php $no = 1; foreach ($d as $key => $value) {
                                        ...
                                        $isHidden = in_array($status, [3, 4, 5]);
                                    ?>
                                    <tr>
                                        <td class="text-center"><?= $no++ ?></td>
                                        <td><?= $value['kode_barang'] ?></td>
...
<div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a id="btnKirimPengajuan" href="#" class="btn btn-warning" style="display: none;">
...
$(document).ready(function() {
    $('#infoModal').on('show.bs.modal', function(event) {
        ...
        var statusDisplay = status_text[status] || 'Tidak Diketahui';
        var statusBadge = status_badge_class[status] || 'badge-secondary';
        ...
        modal.find('#infoStatus').html('<span class="badge ' + statusBadge + ' p-2" style="font-size: 14px;">' + statusDisplay + '</span>');
        ...
        // Atur tombol Kirim Pengajuan (hanya muncul jika kondisi == 1 && status != 3,4,5)
        if (kondisi == 1 && status != 3 && status != 4 && status != 5) {
