                  ...
                  <div class="card-body">
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <a class="btn btn-warning btn-sm" href="<?= base_url('lokasi/edit/' . $value['id']) ?>"><i class="fas fa-edit"></i></a>
                        <!-- <a href="<?= base_url('lokasi/detail/' . $value['id']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-info-circle"></i></a> -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
                <h4 class="modal-title font-weight-bold ml-auto">Tambah Data Lokasi</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input name="nama" class="form-control" placeholder="Lokasi.." required>
                </div>

                <div class="form-group">
                    <label>Leader</label>
                    <input name="leader" class="form-control" placeholder="Nama Leader.." required>
                </div>
            </div>
        ...
        <div class="modal fade" id="delete<?= $value['id'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a href="<?= base_url('lokasi/delete/' . $value['id']) ?>" class="btn btn-success">Hapus</a>
